...
\addresses  {\groupname\\\deptname\\\univname}  % Do not change this here, instead these must be set in the "uis-bachelor-master.cls" file, please look through it instead
\date       {\today}
\subject    {}
\keywords   {}
